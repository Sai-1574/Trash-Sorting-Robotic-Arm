...
//     if (command == '1') {
//       executePlasticBagRoutine();
//     }
//   }
// }

// void executePlasticBagRoutine() {
//   moveServoSlowly(BASE_CHANNEL, 90, 90); 
//   moveServoSlowly(SHOULDER_CHANNEL, 140, 140);
//   moveServo(END_EFFECTOR_CHANNEL,160);       // Set base to starting position if not already there
//   // moveServo(END_EFFECTOR_CHANNEL, 140);       // Start with gripper open
//   delay(100);
...
void loop() {
  ...
  //   if (command == '1') {
  //     Serial.println("Executing Routine 1: plastic_bag");
  //     executePlasticBagRoutine();
  //   }
  //   else if (command == '2') {
  //     Serial.println("Executing Routine 2: scrap_paper");
  //     executeScrapPaperRoutine();
  //   }
  // }
